...
* Column Order: Exact order as requested (id, used, ps, dprime_h, dprime_s, event_t01...event_t100, h_t01...h_t100, s_t01...s_t100, ds_dec_t01...ds_dec_t100)✅ Signal Counts: Each row has exactly round(ps*100) signal labels
