...
for _, idx in merged_df.groupby('id').indices.items():
    ...
    for w in rolling_windows:
        ...
        # System confusion matrix rolling rates
        ...
        sub[f'system_tn_rate_rolling_{w}']    = sub['system_tn'].rolling(w, min_periods=1).mean().shift(1)
        
        # DS confusion matrix rolling rates
        ...
        sub[f'ds_tn_rate_rolling_{w}']        = sub['ds_tn'].rolling(w, min_periods=1).mean().shift(1)
