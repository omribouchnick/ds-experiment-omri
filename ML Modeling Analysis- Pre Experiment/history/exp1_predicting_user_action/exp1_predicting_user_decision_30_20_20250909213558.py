...
rolling_windows = [1,3,7,14,21,30]  # Max 30 trials for rolling windows
...
def per_user_chrono_split(df, user_col='id', order_cols=('block','trial'), test_ratio=0.4):  # 40% for test (20 trials), 60% for train (30 trials)
